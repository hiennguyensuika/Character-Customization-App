    ...
    <div className="App">
      ...
      <div className="avatar-group gap-30">
        <div className="avatar-area">
          <div className="group-button-change">
            <ChangeButton
              stateName="Body"
              state={body}
              setStateValue={setBody}
              total={total.body}
            />
            <ChangeButton
              stateName="Eyes"
              state={eyes}
              setStateValue={setEyes}
              total={total.eyes}
            />
            <ChangeButton
              stateName="Eyebrows"
              state={eyebrows}
              setStateValue={setEyebrow}
              total={total.eyebrows}
            />
            <ChangeButton
              stateName="Hair"
              state={hair}
              setStateValue={setHair}
              total={total.hair}
            />
            <ChangeButton
              stateName="Mouth"
              state={mouth}
              setStateValue={setMouth}
              total={total.mouth}
            />
            <ChangeButton
              stateName="Glasses"
              state={glasses}
              setStateValue={setGlasses}
              total={total.glasses}
            />
            <ChangeButton
              stateName="Clothing1"
              state={clothing1}
              setStateValue={setClothing1}
              total={total.clothing1}
            />
            <ChangeButton
              stateName="Clothing2"
              state={clothing2}
              setStateValue={setClothing2}
              total={total.clothing2}
            />
            <ChangeButton
              stateName="Clothing3"
              state={clothing3}
              setStateValue={setClothing3}
